...
Serves from project root. Opens http://localhost:3000. Both static and semag games work (semag served from local files).
...
## Manual R2 Local Test

To test R2 locally without npm script:
