console.log("LaggedAPI Revenue Share: v1.8.2");
...
//
//to do: track dev revenue: 
//
function onPaidEventHandler(ilar_message) {

  console.log("adsense message onPaidEvent: ", ilar_message);
...
approvedDomainsList = ['lagged.com','lagged.app','lagged.dev','brainplay.com'];
